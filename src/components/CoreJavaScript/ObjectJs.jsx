...
import { loopData } from '../../staticData/loopData';
import { arrayData } from '../../staticData/arrayData';
import { objectData } from '../../staticData/objectsData';

const ObjectJs = () => {
    return (
        <Box pb={2}>
            <Typography variant='h3'>
                Technical Assessment of JavaScript (Object)
            </Typography>
            {objectData?.map(data => <DesignedTechnicalBox marginT="20px" key={data?.id}>
