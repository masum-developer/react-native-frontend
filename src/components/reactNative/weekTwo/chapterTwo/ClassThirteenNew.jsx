  ...
  return (
    <Box>
      ...
      <Box>
        ...
        <Typography>
          If you haven't already installed React Navigation and its
          dependencies, you need to do so. Run the following command in your
          project directory:
        </Typography>
...
export default ClassThirteenNew;
