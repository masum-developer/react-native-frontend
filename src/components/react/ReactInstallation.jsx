...
const ReactInstallation = () => {
    return (
        <Box>
            <Typography variant='h3'>How to install ReactJs?</Typography>
            <Typography variant='subtitle2'>
                To install React.js, you first need to have Node.js and npm (Node Package Manager) installed on your computer. Follow these steps:
            </Typography>
            ...
            <Box mt={3}>
                ...
                <Box mt={3}>
                    ...
                    <Process list={["Once you have Node.js and npm installed, you can create a new React.js project by running the following command:"]}></Process>
                    <ImageComp image={"/react/Screenshot_3.png"} imageTitle={"Screenshot 3: Installing"}></ImageComp>
                </Box>

                <Box mt={3}>
                    <StepComp stepText="Step 4:"></StepComp>
                    <Process list={["After the command finishes running, choose javascript for language selection"]}></Process>
                    <ImageComp image={"/react/Screenshot_4.png"} imageTitle={"Screenshot 4: Installing"}></ImageComp>
                </Box>

                <Box mt={3}>
                    <StepComp stepText="Step 5:"></StepComp>
                    <Process list={["After the command finishes running, change into the project directory by running and download dependencies"]}></Process>
                    <ImageComp image={"/react/Screenshot_5.png"} imageTitle={"Screenshot 4: Installing"}></ImageComp>
                </Box>
