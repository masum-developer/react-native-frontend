...
const AgileExecution = () => {
    const userStory = {
        title: 'Dashboard view of the project',
        assignedTo: 'Rafiur Rahman Protik',
        description: {
            title: "As a developer, I want to implement the dashboard view with the total number of items and with a table that contains the items.",
            list: [
                "Give total tasks, epic, features, bugs, and user stories.",
    ...
    return (
        <Box>
            ...
            <Box mt={2}>
                ...
                <Typography variant='h4' mt={2}>Here we give some information related to dashboard view user story:
                </Typography>
