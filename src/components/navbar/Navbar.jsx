    ...
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center" }}>
      ...
      <Stack direction="column" alignItems="center" justifyContent="center">
        ...
        <Box mt={2}>
          <a
            target="_blank"
            href="https://ts4u.us/auth/register"
            rel="noopener noreferrer"
          >
            <ButtonComp background="#313641" myWidth="110px" color="white">
              Sign Up
            </ButtonComp>
          </a>
        </Box>
    ...
    <Box>
      <AppBar
        sx={{
          ...
          background: "#FFFFFF",
          boxShadow:
            "1px 635px 254px rgba(0, 0, 0, 0.01), 1px 357px 214px rgba(0, 0, 0, 0.05), 0px 159px 159px rgba(0, 0, 0, 0.09), 0px 40px 87px rgba(0, 0, 0, 0.1), 0px 0px 0px rgba(0, 0, 0, 0.1)",
          height: { xs: "70px", sm: "108px" },
          padding: "0",
        }}
      >
        <Container>
          <Toolbar>
            ...
            <Box direction="row">
              ...
              >
                <SearchIconWrapper>
                  <SearchIcon style={{ color: "black", marginLeft: "20px" }} />
                </SearchIconWrapper>
                <input
                  ...
                  <div className="dataResult">
                    {filteredData.slice(0, 15).map((value, key) => {
                      return (
                        <a
                          className="dataItem"
                          onClick={() => handleSearchRouter(value?.link)}
                        >
                          <p>{value?.title} </p>
                        </a>
                      );
            ...
            <Box direction="row" sx={{ display: { xs: "none", md: "block" } }}>
              {isAuthenticated ? (
                ...
                <>
                  <Link href="/auth/login">
                    <ButtonComp style={{ marginLeft: "5px" }} myWidth="110px">
                      Sign In
                    </ButtonComp>
                  </Link>
