...
const list = [
    ...
    "SEO Benefits: Next.js supports server-side rendering, which is beneficial for search engine optimization (SEO). By providing pre-rendered HTML to search engines, Next.js allows for better indexing and ranking of web pages.",
...
const list1 = [
    "Server-side Rendering (SSR): When a user requests a page, Next.js renders the initial HTML on the server and sends it to the client. This approach allows search engines to crawl and index the content effectively. Additionally, the pre-rendered HTML provides faster initial page loads for users.",
...
const NextIntroduction = () => {
    return (
        <Box>
            ...
            <Typography variant='subtitle2'>NextJS is a popular React framework that simplifies the development of server-side rendered (SSR) and statically generated (SSG) web applications. It builds upon React and provides additional features and conventions to enhance the development experience. Next.js aims to solve challenges faced by traditional single-page applications (SPAs) built with React by introducing server-side rendering, static site generation, and other performance optimizations.</Typography>


                <Box mt={3}>
            <Typography variant='h3'>Why is NextJS used?</Typography>

                    <Typography variant='subtitle2'>NextJS is used for several reasons, including:</Typography>
