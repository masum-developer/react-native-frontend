...
const Switch = () => {
    ...
    const data = useFind(JsData, 'switch');

    //destructuring
    const { title, desc, codeTemplate, desc_2, codeTemplate_2, desc_3, section1, section2, section3, section4, section5, section6 } = data || {};
    const { title1, desc1, desc1_2, list1 } = section1 || {};
    ...
    const { desc6, codeTemplate6, desc6_2, codeTemplate6_2, desc6_3 } = section6 || {};
        ...
        <>{Object.keys(data).length > 0 ?
            <Box>
                ...
                <Box mt={3}>
                    ...
                    <CodeBox codeSnippet={codeTemplate6_2}></CodeBox>
                    <Typography variant='subtitle1'>{desc6_3}</Typography>
                </Box>
