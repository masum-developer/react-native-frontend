...
const AsynchronousComp = () => {
    //fetching data from custom hooks
    const data = useFind(JsData, 'asynchronous');
    ...
    const { title2, desc2, codeTemplate2, desc2_2, desc2_3, codeTemplate2_2, desc2_4 } = section2 || {};
...
export default AsynchronousComp;