...
import SelectorsOutput from '../global/SelectorsOutput';
...
const SassSelectors = () => {
    ...
    const data = useFind(SassData, 'sassselector');
    //destructuring
    ...
    const {title3,desc3,desc3_1,codeTemplate3_1,codeTemplate3_2,desc3_2,codeTemplate3_3,codeTemplate3_4,codeTemplate3_5,codeTemplate3_6,codeTemplate3_7, desc3_3,desc3_4,desc3_5,desc3_6,desc3_7} = section3 || {};
    ...
    return (
        <>{Object.keys(data).length > 0 ?
            <Box>
                ...
                <Box>
                <CodeBox codeSnippet={codeTemplate3_6}></CodeBox>
                </Box> 
                <Typography mt={3}
                ...
                <Box>
                <CodeBox codeSnippet={codeTemplate3_7}></CodeBox>
                </Box> 
                ...
                <SelectorsOutput></SelectorsOutput>
