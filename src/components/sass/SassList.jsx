...
import SassListOutput from '../global/SassListOutput';
...
const SassList = () => {
    ...
    const data = useFind(SassData, 'sasslist');
    //destructuring
    ...
    const {title3,desc3,desc3_1,codeTemplate3_1,codeTemplate3_2,desc3_2,codeTemplate3_3,codeTemplate3_4,codeTemplate3_5, desc3_3,desc3_4,desc3_5,desc3_6} = section3 || {};
